...
export const DungeonTab = ({ selectedDungeon, setSelectedDungeonCallback, refetchDungeonCallback }: Props) => {
            ...
            <ButtonRow
              buttons={[
                ...
                },
                {
                  ...
                  onClick: async () => {
                    const { httpCode } =
                      await dungeonDataFetcher.deleteSingle(selectedDungeon?.id);
